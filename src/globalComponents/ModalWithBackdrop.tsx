...
export default function ModalWithBackdrop(props: PropsWithChildren<ModalWithBackdropProps>) {
    ...
    return <div className={`absolute h-screen w-screen left-0 bottom-0 z-[100] flex justify-center items-center backdrop-blur-sm overflow-hidden`} onClick={() => { onClick && onClick() }}>
